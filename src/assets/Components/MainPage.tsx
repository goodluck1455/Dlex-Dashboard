...
const HomeReadingWork = lazy(
  () => import("../ReUseAbleComponent/HomeReadingWork")
);
...
export default function MainPage() {
  ...
  return (
    <div
      className=" flex gap-8 SideBar___body  top-0 left-0 h-screen  max-xl:gap-1 max-2xl:gap-2 
    ...
    >
      <div className="SideBar___body flex-grow-1 scroll-smooth overflow-y-auto mb-3 mx-4">
        ...
        <div className="  mt-[2rem]">
          <section>
            <h4 className="text-[#181819e6] font-bold tracking-[-0.478125px] text-[22.95px]">
              Progress Dashboard
            </h4>
          </section>
        ...
        <section>
          <div className="mt-8 flex gap-6 items-center max-sm:flex-col overflow-hidden">
            ...
            >
              <h3 className="text-[#181819e6] tracking-[-0.3825px] mt-4 font-bold">
                Overall progress
              </h3>
              ...
              <div className="flex items-center mt-8 justify-between">
                <div>
                  <h3
                    className="text-[#181819e6] tracking-[-0.765px] 
                    text-[22.95px] leading-[120%] font-[400]"
                  >
              ...
              <div className="bg-[#F0F1F2] w-full h-[7.65px] rounded-[3.825px] mt-3">
                <div className="h-full bg-[#3855B3] w-[236.19px]"></div>
              </div>
              ...
              <div className="float-right mt-2">
                <div className="flex items-center cursor-pointer">
                  <div>
                    <p className="text-[#3855b3e6] tracking-[-0.286875px]">
                      Explore more
                    </p>
                  </div>
                  <div>
            ...
            <div className="bg-[#FFFFFF] flex items-center justify-between  px-4 border-[#E6E7E9] border-[0.95625px] rounded-[11.475px] w-full h-[84.15px]">
              <div className="flex gap-2 items-center mt-3">
                ...
                <div>
                  ...
                  <p className="text-[#1818196b] tracking-[-0.478125px] text-[11.475px]">
                    +30 grammer rules
                  </p>
                </div>
              </div>
      ...
      <Suspense fallback={<SkeletonLoader />}>
        <div
          className={`${
            rightbar ? "max-lg:block  max-lg:absolute" : "max-lg:hidden"
          }  
         ${rightbar ? "max-sm:block  max-sm:absolute" : "max-sm:hidden"} 
         ${
           rightbar ? "max-xl:block  max-xl:absolute" : "max-xl:hidden"
         } max-lg:z-20`}
        >
